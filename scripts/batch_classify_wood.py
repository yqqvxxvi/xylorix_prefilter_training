#!/usr/bin/env python3
"""
Batch classify images as wood vs non-wood using CNN model.

Usage:
    python scripts/batch_classify_wood.py --model models/cnn/best_model.pt --input-dir images/ --output-dir classified/
    python scripts/batch_classify_wood.py --model models/cnn/best_model.pt --input-dir images/ --output-dir classified/ --threshold 0.6 --copy-files
"""
...
def predict_image(image_path, model, transform, device, threshold=0.5, num_classes=1):
    """Predict wood probability for a single image."""
    try:
...
def main():
    ...
    parser.add_argument('--copy-files', action='store_true',
                        help='Copy images to wood/ and non_wood/ subdirectories')
    ...
    print("=" * 70)
    print("BATCH WOOD CLASSIFICATION")
    print("=" * 70)
